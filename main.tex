...
complex virutal environments are created where the human presence plays a
...
repeatablity of the experimental conditions, important to assess the
...
MORSE (figure ~\ref{fig|hanp}). This simulated environment was
...
automatic testing of more and more complex scenarii, including long-term
interaction.
