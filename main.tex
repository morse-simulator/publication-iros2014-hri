...
As such, the five scenarios that are presented here cover a range of use-cases.
Using a simulator to provide a reference environment with repeatable conditions
(as in scenarios~\ref{sc:assessment}, \ref{sc:expectations} and
...
In these scenarios, simulation also appears useful to test a variety of different
